...
Java.perform(function(){
let Companion = Java.use("com.jiolib.libclasses.utils.AesUtil$Companion");
Companion["encryptJson"].implementation = function (jsonData, key, iv) {
    console.log(`Companion.encryptJson is called: jsonData=${jsonData}, key=${key}, iv=${iv}`);
    let result = this["encryptJson"](jsonData, key, iv);
    console.log(`Companion.encryptJson result=${result}`);
    return result;
};
});
...
Java.perform(function(){
	let Companion = Java.use("com.jiolib.libclasses.utils.AesUtil$Companion");
Companion["encrypt"].implementation = function (plainData, key, iv) {
    console.log(`Companion.encrypt is called: plainData=${plainData}, key=${key}, iv=${iv}`);
    let result = this["encrypt"](plainData, key, iv);
    console.log(`Companion.encrypt result=${result}`);
    return result;
};
});
...
Java.perform(function(){
let Companion = Java.use("com.jiolib.libclasses.utils.AesUtil$Companion");
Companion["decryptJson"].implementation = function (encryptedJson, key) {
    console.log(`Companion.decryptJson is called: encryptedJson=${encryptedJson}, key=${key}`);
    let result = this["decryptJson"](encryptedJson, key);
    console.log(`Companion.decryptJson result=${result}`);
    return result;
};
});

Java.perform(function () {
    var GetTranskeyResponseModel = Java.use("com.jio.myjio.bank.model.GetTranskeyResponseModel");

    GetTranskeyResponseModel.toString.implementation = function () {
        var result = this.toString();
        var transKey = this.transKey.value; // Extracting the transKey
